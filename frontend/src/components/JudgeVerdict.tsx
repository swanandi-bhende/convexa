...
export function JudgeVerdict({ pending, round, bullScore, bearScore }: JudgeVerdictProps) {
  ...
  return (
    <section className="rounded-3xl bg-slate-950 p-6 text-slate-100 shadow-[0_14px_28px_rgba(15,23,42,0.28)]">
      ...
      {pending ? (
        ...
        <div className="mt-4 rounded-2xl bg-slate-900 px-4 py-5">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tight text-white">{winner}</p>
